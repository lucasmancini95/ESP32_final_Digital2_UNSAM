 ...
 */
void i2c_driver_install(i2c_port_t i2c_num, i2c_mode_t mode, size_t slv_rx_buf_len, size_t slv_tx_buf_len, int intr_alloc_flags);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_driver_delete(i2c_port_t i2c_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_param_config(i2c_port_t i2c_num, const i2c_config_t* i2c_conf);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_reset_tx_fifo(i2c_port_t i2c_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_reset_rx_fifo(i2c_port_t i2c_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_isr_register(i2c_port_t i2c_num, void (*fn)(void*), void * arg, int intr_alloc_flags, intr_handle_t *handle);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_isr_free(intr_handle_t handle);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_set_pin(i2c_port_t i2c_num, int sda_io_num, int scl_io_num,
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_master_start(i2c_cmd_handle_t cmd_handle);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_master_write_byte(i2c_cmd_handle_t cmd_handle, uint8_t data, bool ack_en);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_master_write(i2c_cmd_handle_t cmd_handle, uint8_t* data, size_t data_len, bool ack_en);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_master_read_byte(i2c_cmd_handle_t cmd_handle, uint8_t* data, i2c_ack_type_t ack);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_master_read(i2c_cmd_handle_t cmd_handle, uint8_t* data, size_t data_len, i2c_ack_type_t ack);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_master_stop(i2c_cmd_handle_t cmd_handle);
 ...
 *     - voidIMEOUT Operation timeout because the bus is busy.
 */
void i2c_master_cmd_begin(i2c_port_t i2c_num, i2c_cmd_handle_t cmd_handle, TickType_t ticks_to_wait);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_set_period(i2c_port_t i2c_num, int high_period, int low_period);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_get_period(i2c_port_t i2c_num, int* high_period, int* low_period);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_filter_enable(i2c_port_t i2c_num, uint8_t cyc_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_filter_disable(i2c_port_t i2c_num);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_set_start_timing(i2c_port_t i2c_num, int setup_time, int hold_time);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_get_start_timing(i2c_port_t i2c_num, int* setup_time, int* hold_time);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_set_stop_timing(i2c_port_t i2c_num, int setup_time, int hold_time);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_get_stop_timing(i2c_port_t i2c_num, int* setup_time, int* hold_time);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_set_data_timing(i2c_port_t i2c_num, int sample_time, int hold_time);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_get_data_timing(i2c_port_t i2c_num, int* sample_time, int* hold_time);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_set_timeout(i2c_port_t i2c_num, int timeout);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_get_timeout(i2c_port_t i2c_num, int* timeout);
/**
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_set_data_mode(i2c_port_t i2c_num, i2c_trans_mode_t tx_trans_mode, i2c_trans_mode_t rx_trans_mode);
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
void i2c_get_data_mode(i2c_port_t i2c_num, i2c_trans_mode_t *tx_trans_mode, i2c_trans_mode_t *rx_trans_mode);
